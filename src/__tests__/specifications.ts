...
test('\nspecifications in isolation', (t) => {
  ...
  if (typeof ''.startsWith === 'function') {
    t.ok(
      spok.startsWith('hello')('hello world'),
      'startsWith hello, helloWorld'
    )
    t.ok(
      !spok.startsWith('hallo')('hello world'),
