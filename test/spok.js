...
test('\nmultiple specifications all valid', function(t) {
  ...
  t.deepEqual(equalCalls,
    [ { actual: 1, expected: 1, msg: 'spok: spok-test-valid' },
      ...
      { actual: 1,
        expected: 1,
        msg: '·· spok: spok-test-valid.object' },
...
test('\nmultiple specifications some invalid', function(t) {
  ...
  t.deepEqual(equalCalls,
    [ { actual: 1, expected: 1, msg: 'spok: spok-test-invalid' },
      ...
      { actual: 1,
        expected: 1,
        msg: '·· spok: spok-test-invalid.object' },
...
test('\nnested specifications all valid', function(t) {
  ...
  t.deepEqual(equalCalls,
    [ { actual: 1, expected: 1, msg: 'spok: spok-nested-all-valid' },
      { actual: true,
        expected: true,
        msg: '·· file = \'/Volumes/d/dev/js/async-hooks/ah-fs/test/read-one-file.js\'' },
      ...
      { actual: true,
        expected: true,
        msg: '·· location = \'onread (/Volumes/d/dev/js/async-hooks/ah-fs/test/read-one-file.js:39:17)\'' },
      { actual: 1,
        expected: 1,
        msg: '·· spok: spok-nested-all-valid.args' },
